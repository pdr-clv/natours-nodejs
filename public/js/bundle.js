...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); //TRICK we go one element parent from (el), and then we remove child, this is the way to remove alert.
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'User created sucessfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Check your email to reset your passport!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your password was reset successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            urlEndPoint = type === 'password' ? 'updatepassword' : 'updateme';
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users/".concat(urlEndPoint),
              data: data
            });
...
var stripe = Stripe('pk_test_51I0SLgA8Kj6Oi952x8w8R0iGoYDzejlQ0LCAJCMC7vi8bXcGSsl9trqnGDC7HLnEaKTn3MvNVwG2z8rL2bGMwpxu00z8fH5pgj');
...
var resetPasswordForm = document.querySelector('.form--reset-password'); //DELEGATION OF FUNCTIONS
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault(); //little trick to create an animation, instead an spinner to inform user password is updating while the async request.
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            e.target.textContent = 'Processing ...'; //const tourId = e.target.dataset.tourId // data-tour-id in property, becomes tourId del dataset
